...
# # In-memory storage for shared summaries
# shared_summaries = {}
...
#         print(f"Translating to: {target_lang}")  # Debug line
        
#         translated = translate_text(text, target_lang)
        
#         print(f"Translation result: {translated[:50]}...")  # Debug line
...
#         })
#     except Exception as e:
#         print(f"Translation error in route: {e}")  # Debug line
#         return jsonify({'error': str(e)}), 500
...
#             pdf_path,
#             as_attachment=True,
#             download_name=f'summary_{language}.pdf',
...
#         # Generate shareable link - using request.url_root for proper URL
#         share_url = f"{request.url_root}view/{share_id}"
#         share_url = share_url.replace('//', '/')  # Fix any double slashes
        
#         print(f"Created share link: {share_url}")  # Debug
#         print(f"Share ID: {share_id}")  # Debug
#         print(f"Stored data: {shared_summaries[share_id]}")  # Debug
...
#         })
#     except Exception as e:
#         print(f"Share error: {str(e)}")  # Debug
#         return jsonify({'error': str(e)}), 500

# @app.route('/view/<share_id>')
# def view_shared(share_id):
#     print(f"Viewing share ID: {share_id}")  # Debug
#     print(f"Available shares: {list(shared_summaries.keys())}")  # Debug
    
#     summary_data = shared_summaries.get(share_id)
#     if not summary_data:
#         return "Summary not found or expired", 404
    
#     return render_template('shared.html', data=summary_data)
...
if __name__ == '__main__':
    # Port 5001 use karo to avoid macOS AirPlay conflict
